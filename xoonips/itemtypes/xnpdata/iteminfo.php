...
$iteminfo['orm'][] = array(
    ...
    'foreign_key' => 'data_id',
    'multiple'    => true,
    'criteria'    => $experimenter_order_criteria
);
$iteminfo['orm'][] = array(
    'module'      => 'xoonips',
    'name'        => 'file',
    'field'       => 'data_file',
    'foreign_key' => 'item_id',
    'criteria'    => iteminfo_file_criteria('data_file'),
    'multiple'    => false
);
$iteminfo['orm'][] = array(
    'module'      => 'xoonips',
...
$iteminfo['ormfield']['experimenter'] = array(
    array(
        'name'     => 'experimenter',
        'type'     => 'string',
        'required' => true
...
$iteminfo['io']['xmlrpc']['item'][] = array(
    ...
    'xmlrpc' => array(
        ...
        'options'      => array(
            array(
                'option'       => 'excel',
                'display_name' => '_MD_XNPDATA_XMLRPC_DISPLAY_NAME_DATA_TYPE_EXCEL'
            ),
            array(
                'option'       => 'movie',
                'display_name' => '_MD_XNPDATA_XMLRPC_DISPLAY_NAME_DATA_TYPE_MOVIE'
            ),
            array(
                'option'       => 'text',
                'display_name' => '_MD_XNPDATA_XMLRPC_DISPLAY_NAME_DATA_TYPE_TEXT'
            ),
            array(
                'option'       => 'picture',
                'display_name' => '_MD_XNPDATA_XMLRPC_DISPLAY_NAME_DATA_TYPE_PICTURE'
            ),
            array(
                'option'       => 'other',
                'display_name' => '_MD_XNPDATA_XMLRPC_DISPLAY_NAME_DATA_TYPE_OTHER'
            ),
        ),
        'required'     => true
    )
