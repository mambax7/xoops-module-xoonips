...
$tempUser = $thisUser->getVar('bio', 'n');
$tempTarea = $myts->displayTarea($tempUser, 0, 1, 1);
...
$tempUser = $thisUser->getVar('user_sig', 'n');
$tempTarea = $myts->displayTarea($tempUser, 0, 1, 1);
$xoopsTpl->assign('user_signature', $tempTarea);
