...
/**
 *
 * XmlRpcTransform composer class for Paper type
 *
 *
 */
class XNPPaperXmlRpcTransformCompo extends XooNIpsXmlRpcTransformCompo
{
    /**
     * XNPPaperXmlRpcTransformCompo constructor.
     */
