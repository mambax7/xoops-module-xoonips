 ...
 *
 * @internal param array $online input text array
 */
...
function &_xoonips_eventlog_get($start_time, $end_time, $event_type_id, $query_type)
{
    ...
    switch ($query_type) {
        case 'all':
            ...
            $objs = $eventlogHandler->getObjects($criteria);
            break;
        case 'day':
        case 'total':
            $criteria->setGroupBy('event_date');
            $criteria->setSort('event_date');
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'FROM_UNIXTIME(timestamp, \'%Y-%m-%d\') AS event_date, COUNT(event_type_id) AS cnt');
            break;
        case 'month':
            $criteria->setGroupBy('event_month');
            $criteria->setSort('event_month');
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'FROM_UNIXTIME(timestamp, \'%Y-%m\') AS event_month, COUNT(event_type_id) AS cnt');
            break;
        case 'domain':
            $criteria->setGroupBy('remote_host');
            $criteria->setSort('remote_host');
            $objs = $eventlogHandler->getObjects($criteria, false, 'remote_host, COUNT(event_type_id) AS cnt');
            break;
        case 'item':
            ...
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'FROM_UNIXTIME(timestamp, \'%Y-%m\') AS event_month, basic.item_id, users.uname AS uname, users.name AS name, itemtype.display_name as itemtype_name, COUNT(event_type_id) AS cnt',
                                                  false, $join_criteria);
            break;
        case 'file':
            ...
            $objs = $eventlogHandler->getObjects($criteria, false, 'FROM_UNIXTIME('.$tables['event_log']
                                                                    .'.timestamp, \'%Y-%m\') AS event_month, basic.item_id, file.file_id, file.original_file_name AS fname, users.uname AS uname, users.name AS name, itemtype.display_name as itemtype_name, COUNT(event_type_id) AS cnt',
                                                  false, $join_criteria);
            break;
        case 'user':
            ...
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'CASE WHEN ISNULL(uname) THEN CONCAT(\'guest[\',remote_host,\']\') ELSE uname END AS myuname, FROM_UNIXTIME(timestamp, \'%Y-%m\') AS event_month, users.uname AS uname, COUNT(event_type_id) AS cnt',
                                                  false, $join_criteria);
            break;
        case 'user_item':
            ...
            $join_criteria->cascade(new XooNIpsJoinCriteria('users', 'exec_uid', 'uid', 'INNER', 'users'), 'xoonips_event_log');
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'CASE WHEN ISNULL(uname) THEN CONCAT(\'guest[\',remote_host,\']\') ELSE uname END AS myuname, FROM_UNIXTIME(timestamp, \'%Y-%m\') AS event_month, basic.item_id as item_id, users.uname AS uname, itemtype.display_name as itemtype_name, COUNT(event_type_id) AS cnt',
                                                  false, $join_criteria);
            break;
        case 'item_sort':
            ...
            $criteria->setSort('cnt');
            $criteria->setOrder('DESC');
            $objs = $eventlogHandler->getObjects($criteria, false, 'item_id, COUNT(event_type_id) AS cnt');
            break;
        case 'file_sort':
            $criteria->setGroupBy('file_id');
            $criteria->setSort('cnt');
            $criteria->setOrder('DESC');
            $objs = $eventlogHandler->getObjects($criteria, false, 'file_id, COUNT(file_id) AS cnt');
            break;
        case 'user_item_sort':
            ...
            $join_criteria->cascade(new XooNIpsJoinCriteria('users', 'exec_uid', 'uid', 'INNER', 'users'), 'xoonips_event_log');
            $objs = $eventlogHandler->getObjects($criteria, false,
                                                  'CASE WHEN ISNULL(uname) THEN CONCAT(\'guest[\',remote_host,\']\') ELSE uname END AS myuname, basic.item_id as item_id, users.uname AS uname, COUNT(event_type_id) AS cnt',
                                                  false, $join_criteria);
            break;
    }
...
function xoonips_eventlog_count_items()
{
    ...
    return $ibHandler->getCount($criteria);
}
...
function &xoonips_eventlog_get_items($start, $limit)
{
    ...
    $objs = $ibHandler->getObjects($criteria, false, '', false, $join_criteria);
...
function _xoonips_eventlog_logtype2vars($log_type_id)
{
    static $typemap = array(
        ...
        1 => array(
            ...
            ETID_VIEW_TOP_PAGE,
            'day',
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_DAYS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_DAYS_TITLE,
        ),
        ...
        2 => array(
            ...
            ETID_VIEW_TOP_PAGE,
            'month',
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_MONTHS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_MONTHS_TITLE,
        ),
        ...
        3 => array(
            ...
            ETID_VIEW_TOP_PAGE,
            'total',
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_TOTAL_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_DAYS_TOTAL_TITLE,
        ),
        ...
        4 => array(
            ...
            ETID_VIEW_TOP_PAGE,
            'domain',
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_DOMAINS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_TOP_DOMAINS_TITLE,
        ),
        ...
        5 => array(
            ...
            ETID_VIEW_ITEM,
            'day',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_DAYS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_DAYS_TITLE,
        ),
        ...
        6 => array(
            ...
            ETID_VIEW_ITEM,
            'month',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_MONTHS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_MONTHS_TITLE,
        ),
        ...
        7 => array(
            ...
            ETID_VIEW_ITEM,
            'total',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_TOTAL_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_DAYS_TOTAL_TITLE,
        ),
        ...
        8 => array(
            ...
            ETID_VIEW_ITEM,
            'domain',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_DOMAINS_LABEL,
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_DOMAINS_TITLE,
        ),
        ...
        18 => array(
            ...
            ETID_VIEW_ITEM,
            'item',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_PER_ITEM_LABEL,
            '',
        ),
        ...
        19 => array(
            ...
            ETID_VIEW_ITEM,
            'user_item',
            _MD_XOONIPS_EVENTLOG_ACCESS_ITEM_PER_USER_LABEL,
            '',
        ),
        ...
        9 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'day',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_DAYS_LABEL,
            _MD_XOONIPS_EVENTLOG_DL_ITEM_DAYS_TITLE,
        ),
        ...
        10 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'month',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_MONTHS_LABEL,
            _MD_XOONIPS_EVENTLOG_DL_ITEM_MONTHS_TITLE,
        ),
        ...
        11 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'total',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_TOTAL_LABEL,
            _MD_XOONIPS_EVENTLOG_DL_ITEM_DAYS_TOTAL_TITLE,
        ),
        ...
        12 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'domain',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_DOMAINS_LABEL,
            _MD_XOONIPS_EVENTLOG_DL_ITEM_DOMAINS_TITLE,
        ),
        ...
        15 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'item',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_PER_ITEM_LABEL,
            '',
        ),
        ...
        16 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'file',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_PER_FILE_LABEL,
            '',
        ),
        ...
        17 => array(
            ...
            ETID_DOWNLOAD_FILE,
            'user',
            _MD_XOONIPS_EVENTLOG_DL_ITEM_PER_USER_LABEL,
            '',
        ),
        // - number of newly registered users and items (user)
        13 => array(
            'newuser',
            ETID_CERTIFY_ACCOUNT,
            'month',
            _MD_XOONIPS_EVENTLOG_NEW_USERS_LABEL,
            _MD_XOONIPS_EVENTLOG_NEW_USER_MONTHS_TITLE,
        ),
        ...
        14 => array(
            ...
            ETID_INSERT_ITEM,
            'month',
            _MD_XOONIPS_EVENTLOG_NEW_ITEMS_LABEL,
            _MD_XOONIPS_EVENTLOG_NEW_ITEM_MONTHS_TITLE,
        ),
    );
    ...
    switch ($query_type) {
        ...
        case 'total':
            ...
            for ($i = 0; $i < $days; ++$i) {
                ...
                echo _xoonips_eventlog_array2csv($download, array(
                    $label,
                    $num,
                ));
            }
...
function xoonips_eventlog_download_registered_list($is_post, $log_type_id)
{
    ...
    $condition_map = array(
        ...
        20 => array(
            'user',
            'User List,,%s users',
            'Name,Company,Division,Email',
        ),
        21 => array(
            'item',
            'Item List,,%s items',
            'Item ID,Title,Item Type,Contributor',
        ),
    );
