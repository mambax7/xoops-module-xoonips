...
class XNPStimulusImportItem extends XooNIpsImportItem
{
    ...
    public function setHasStimulusData()
    {
        $this->_has_stimulus_data = true;
    }

    public function unsetHasStimulusData()
    {
        $this->_has_stimulus_data = false;
    }

    /**
     * @return bool
     */
    public function hasStimulusData()
    {
        return $this->_has_stimulus_data;
    }
...
class XNPStimulusImportItemHandler extends XooNIpsImportItemHandler
{
    ...
    /**
     * XNPStimulusImportItemHandler constructor.
     */
    public function __construct()
    {
        parent::__construct();
    ...
    /**
     * @return XNPStimulusImportItem
     */
    public function create()
    {
        return new XNPStimulusImportItem();
    }
    ...
    {
        if ('xnpstimulusimportitem' !== strtolower(get_class($item))) {
            return;
        }

        $this->_set_file_delete_flag($item);

        // nothing to do if file_id is zero
        if ($item->hasStimulusData()) {
            $stimulus_data = $item->getVar('stimulus_data');
            $this->_fix_item_id_of_file($item, $stimulus_data);
            $this->_create_text_search_index($stimulus_data);
        }
