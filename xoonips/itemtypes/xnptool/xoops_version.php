...
$modversion['dirname']     = 'xnptool';

// Sql file (must contain sql generated by phpMyAdmin or phpPgAdmin)
// All tables should not have any prefix!
$modversion['sqlfile']['mysql'] = 'sql/mysql.sql';
$modversion['tables'][0]        = 'xnptool_item_detail';
$modversion['tables'][1]        = 'xnptool_developer';
...
// Templates
$modversion['templates'][1]['file']        = 'xnptool_list_block.tpl';
$modversion['templates'][1]['description'] = 'list block';
$modversion['templates'][2]['file']        = 'xnptool_register_block.tpl';
$modversion['templates'][2]['description'] = 'register block';
$modversion['templates'][3]['file']        = 'xnptool_detail_block.tpl';
$modversion['templates'][3]['description'] = 'detail block';
$modversion['templates'][4]['file']        = 'xnptool_confirm_block.tpl';
$modversion['templates'][4]['description'] = 'confirm block';
$modversion['templates'][5]['file']        = 'xnptool_search_block.tpl';
$modversion['templates'][5]['description'] = 'search block';
$modversion['templates'][6]['file']        = 'xnptool_transfer_item_detail.tpl';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][7]['file']        = 'xnptool_transfer_item_list.tpl';
$modversion['templates'][7]['description'] = '';
$modversion['templates'][8]['file']        = 'xnptool_oaipmh_oai_dc.xml';
$modversion['templates'][8]['description'] = 'OAI-PMH oai_dc';
$modversion['templates'][9]['file']        = 'xnptool_oaipmh_junii2.xml';
...
$modversion['config'][1]['title']       = '_MI_XNPTOOL_CFG_DL_LIMIT';
$modversion['config'][1]['description'] = '_MI_XNPTOOL_CFG_DL_LIMIT_DESC';
