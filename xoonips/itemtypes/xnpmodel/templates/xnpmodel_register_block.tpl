...
<{html_options options=$detail.model_type.select selected=$detail.model_type.value}>
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>">
<{include file='db:xoonips_register_multiple_field.tpl' vars=$xnpmodel_creator}>
    </td>
  </tr>
  <tr>
...
<!-- end of xnpmodel_register_block.tpl -->
