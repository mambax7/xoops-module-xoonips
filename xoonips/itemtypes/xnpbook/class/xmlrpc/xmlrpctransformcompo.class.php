...
/**
 * XmlRpcTransform composer class for Book type.
 */
class XNPBookXmlRpcTransformCompo extends XooNIpsXmlRpcTransformCompo
{
    /**
     * XNPBookXmlRpcTransformCompo constructor.
     */
