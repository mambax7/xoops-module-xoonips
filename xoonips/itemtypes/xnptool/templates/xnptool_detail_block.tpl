...
<{include file='db:xoonips_confirm_multiple_field.tpl' vars=$xoonips_item.xnptool_developer}>
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><{$tool_data.value}></td>
  </tr>
  <tr>
...
<{if $editable }>
<{$basic.hidden}>
<input type="hidden" name="tool_type" value="<{$xoonips_item.detail.tool_type_value}>"/>
...
<input type="hidden" name="tool_dataFileID" value="<{$xoonips_item.detail.tool_data.file_id}>"/>
<{$preview.hidden}>
<{$readme.hidden}>
<{$rights.hidden}>
<{$index.hidden}>
