...
class XooNIpsOrmFileHandler extends XooNIpsTableObjectHandler
{
    ...
    {
        if (null === $joindef || !(is_subclass_of($joindef, 'xoonipsjoincriteria') || strtolower(get_class($joindef)) === 'xoonipsjoincriteria')) {
        ...
        if (trim($fieldlist) == '') {
            $fieldlist
                = "$table.file_id, $table.item_id, $table.original_file_name, $table.mime_type, $table.file_name, $table.file_size, $table.thumbnail_file, $table.caption, $table.sess_id, $table.file_type_id, $table.search_module_name, $table.search_module_version, $table.header, $table.timestamp, $table.is_deleted, $table.download_count";
        }
