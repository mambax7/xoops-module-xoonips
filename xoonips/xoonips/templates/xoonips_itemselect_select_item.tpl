...
<{foreach item=index from=$indexes}>
    / <a href="javascript:void(0);"
         onclick="$('xoonips_hidden_index_id').value=<{$index.index_id}> $('xoonips_hidden_op').value='select_item_index'; $('xoonips_itemselect').submit();"><{$index.title}></a>
    <{/foreach}>
<{/if}>
<br>
<br>
...
<{include file="db:xoonips_item_list_header.tpl"
 order_by=$order_by
 order_dir=$order_dir
 item_per_page=$item_per_page form_id="xoonips_itemselect"}>

<{if $op=="select_item_index"}>
<{include file="db:xoonips_pagenavi.tpl" maxpage=$maxpage page=$page pages=$pages form_id="xoonips_itemselect" pagenavi_extra_onclick="$('xoonips_hidden_op').value='select_item_index_pagenavi';"}>
<{elseif $op=="select_item_useritem"}>
<{include file="db:xoonips_pagenavi.tpl" maxpage=$maxpage page=$page pages=$pages form_id="xoonips_itemselect" pagenavi_extra_onclick="$('xoonips_hidden_op').value='select_item_useritem_pagenavi';"}>
<{elseif $op=="select_item_advancedsearch"}>
<{include file="db:xoonips_pagenavi.tpl" maxpage=$maxpage page=$page pages=$pages form_id="xoonips_itemselect" pagenavi_extra_onclick="$('xoonips_hidden_op').value='select_item_advancedsearch_pagenavi';"}>
<{else}>
