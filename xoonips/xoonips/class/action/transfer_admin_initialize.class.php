...
{
    /**
     * XooNIpsActionTransferAdminInitialize constructor.
     */
    ...
    public function doAction()
    {
        ...
        switch ($this->_formdata->getValue('post', 'op', 's', false)) {
            ...
            case 'to_uid_changed':
                $this->_view_params['to_index_id']
                    = $this->get_private_index_id($this->_view_params['to_uid']);
                break;
            case 'page_changed':
                break;
            default:
        ...
        $this->_view_params['from_index_item_ids']
            = $this->sort_item_ids_by_title($this->get_from_index_item_ids());
