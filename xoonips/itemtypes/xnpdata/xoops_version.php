...
// Templates
$modversion['templates'][1]['file']        = 'xnpdata_list_block.tpl';
$modversion['templates'][1]['description'] = 'list block';
$modversion['templates'][2]['file']        = 'xnpdata_register_block.tpl';
$modversion['templates'][2]['description'] = 'register block';
$modversion['templates'][3]['file']        = 'xnpdata_detail_block.tpl';
$modversion['templates'][3]['description'] = 'detail block';
$modversion['templates'][4]['file']        = 'xnpdata_confirm_block.tpl';
$modversion['templates'][4]['description'] = 'confirm block';
$modversion['templates'][5]['file']        = 'xnpdata_search_block.tpl';
$modversion['templates'][5]['description'] = 'search block';
$modversion['templates'][6]['file']        = 'xnpdata_transfer_item_detail.tpl';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][7]['file']        = 'xnpdata_transfer_item_list.tpl';
