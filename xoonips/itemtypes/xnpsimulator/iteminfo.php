...
$iteminfo['orm'][] = array(
    'module'      => 'xoonips',
    'name'        => 'file',
    'field'       => 'simulator_data',
    'foreign_key' => 'item_id',
    'criteria'    => iteminfo_file_criteria('simulator_data'),
    'multiple'    => false
);
$iteminfo['orm'][] = array(
    'module'      => 'xoonips',
...
$iteminfo['io']['xmlrpc']['item'][] = array(
    ...
    'xmlrpc' => array(
        ...
        'options'      => array(
            array(
                'option'       => 'matlab',
                'display_name' => '_MD_XNPSIMULATOR_XMLRPC_DISPLAY_NAME_SIMULATOR_TYPE_MATLAB'
            ),
            array(
                'option'       => 'mathematica',
                'display_name' => '_MD_XNPSIMULATOR_XMLRPC_DISPLAY_NAME_SIMULATOR_TYPE_MATHEMATICA'
            ),
            array(
                'option'       => 'program',
                'display_name' => '_MD_XNPSIMULATOR_XMLRPC_DISPLAY_NAME_SIMULATOR_TYPE_PROGRAM'
            ),
            array(
                'option'       => 'other',
                'display_name' => '_MD_XNPSIMULATOR_XMLRPC_DISPLAY_NAME_SIMULATOR_TYPE_OTHER'
            ),
        ),
        'multiple'     => false,
        'required'     => true
