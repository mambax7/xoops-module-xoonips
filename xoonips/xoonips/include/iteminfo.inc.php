...
$iteminfo['io']['xmlrpc']['item'][] = array(
    ...
    'eval'   => array(
        'orm2xmlrpc' => '$userHandler = xoops_getHandler( "user" ); $user =  $userHandler->get($in_var[0]); if( $user ) $out_var[0] = $user->getVar( "uname", "none" );',
        'xmlrpc2orm' => '$userHandler = xoops_getHandler( "user" ); $users =  $userHandler->getObjects(new Criteria( "uname", trim($in_var[0]) ) ); if($users) $out_var[0] = $users[0]->getVar( "uid" );'
    )
);
...
$iteminfo['io']['xmlrpc']['item'][] = array(
    ...
    'xmlrpc' => array(
        ...
        'options'      => array(
            array(
                'option'       => 'jpn',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_JPN'
            ),
            array(
                'option'       => 'eng',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_ENG'
            ),
            array(
                'option'       => 'fra',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_FRA'
            ),
            array(
                'option'       => 'deu',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_DEU'
            ),
            array(
                'option'       => 'esl',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_ESL'
            ),
            array(
                'option'       => 'ita',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_ITA'
            ),
            array(
                'option'       => 'dut',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_DUT'
            ),
            array(
                'option'       => 'sve',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_SVE'
            ),
            array(
                'option'       => 'nor',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_NOR'
            ),
            array(
                'option'       => 'dan',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_DAN'
            ),
            array(
                'option'       => 'fin',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_FIN'
            ),
            array(
                'option'       => 'por',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_POR'
            ),
            array(
                'option'       => 'chi',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_CHI'
            ),
            array(
                'option'       => 'kor',
                'display_name' => '_MD_XOONIPS_XMLRPC_DISPLAY_NAME_LANG_KOR'
            )
        ),
        'multiple'     => false,
        'required'     => true
