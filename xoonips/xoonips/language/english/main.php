...
define('_MD_XOONIPS_ITEM_NEED_TO_BE_CERTIFIED',
       'It needs to be certified by a moderator or a group administrator to open this item to the public. It will take a few days.');
...
define('_MD_XOONIPS_ITEM_WARNING_ITEM_STORAGE_LIMIT',
       'Not enough disk space. No more items are able to be registered. Please contact administrator.');
...
define('_MD_XOONIPS_ACTIVATE_BY_USER_CERTIFY_MANUAL',
       'An e-mail has been sent to the registered e-mail address. You will need to activate your account by following the instructions in the e-mail. After completing the activation, please wait for certification of your account from the moderator.');
define('_MD_XOONIPS_ACTIVATE_BY_USER_CERTIFY_AUTO',
       'An e-mail has been sent to the registered e-mail address. Please follow the instructions in the e-mail to activate your account.');
define('_MD_XOONIPS_ACTIVATE_AUTO_CERTIFY_MANUAL',
       'An e-mail has sent to a moderator. Wait for your account certification. You get a notice of certification by e-mail. ');
define('_MD_XOONIPS_ACTIVATE_AUTO_CERTIFY_MANUAL_MAILNG',
       'Failed in sending e-mail to moderator to request your account certification. Contact to an adminstrator or a moderator.');
define('_MD_XOONIPS_ACTIVATE_AUTO_CERTIFY_AUTO',
       'Your account has been certified. You have an access to this site with username and password you registered.');
define('_MD_XOONIPS_ACTIVATE_BY_ADMIN_CERTIFY_AUTO',
       'The account of the user has been registered. Wait for your account activation. You get a notice of activation by e-mail.');
define('_MD_XOONIPS_ACTIVATE_BY_ADMIN_CERTIFY_MANUAL',
       'The account of the user has been registered. Wait for your account activation and certification. You get a notice of certification by e-mail.');
define('_MD_XOONIPS_ACTIVATE_BY_ADMIN_MAILNG',
       'Failed in sending e-mail to an adminstrator to request your account activation. Contact to an adminstrator.');

define('_MD_XOONIPS_ACTIVATED_BY_USER_CERTIFIED_AUTO',
       'Your account of the user has been certified. You have an access to this site with username and password you registered.');
define('_MD_XOONIPS_ACTIVATED_BY_ADMIN_CERTIFIED_AUTO',
       'The account of the user has been activated and certified. An e-mail to notice certification has been sent to registered address.');
define('_MD_XOONIPS_ACTIVATED_BY_ADMIN_CERTIFIED_AUTO_MAILNG',
       'The account of the user has been activated and certified. However, failed in sending e-mail of notice to registered address.');
define('_MD_XOONIPS_ACTIVATED_BY_USER_AND_CERTIFY_MANUAL',
       'Your account has been activated. Please wait for its certification before to use it. The certification will be notified to you by an e-mail from the moderator.');
define('_MD_XOONIPS_ACTIVATED_BY_ADMIN_AND_CERTIFY_MANUAL',
       'The account has been activated. After moderator certifies the account, an email is sent to registered address.');
define('_MD_XOONIPS_ACTIVATED_BY_USER_AND_CERTIFY_MANUAL_MAILNG',
       'Failed in sending e-mail to moderator to request your account certification. Contact to a moderator.');
...
define('_MD_XOONIPS_ACCOUNT_NOT_ACTIVATED',
       "You can't access this area because you are not certified. Wait for your account certification. You get a notice of certification by e-mail.");
...
define('_MD_XOONIPS_EVENTLOG_EVENT_COLUMNS',
       'Event Type,Timestamp,Exec UID,Remote Host,Index ID,Item ID,File ID,UID,GID,Search Keyword,Login Name,Additional Information');
// - for CSV files
...
define('_MD_XOONIPS_ITEM_LANG_OPTION_NAMES',
       'English,Japanese,French,German,Spanish,Italian,Dutch,Swedish,Norwegian,Danish,Finnish,Portuguese,Chinese,Korean');
...
define('_MD_XOONIPS_ITEM_ATTACHMENT_DL_NOTIFY_EXPLANATION',
       'This option is effective only if download limitation option is "login user" and event "notify when item is downloaded" is "on"');
...
define('_MD_XOONIPS_TRANSFER_USER_ITEM_LIST_CAN_NOT_TRANSFER_THIS_ITEM_HAVE_ANOTHER_PARENT',
       "Can not transfer this item because it's referred from other items.");
...
define('_MD_XOONIPS_TRANSFER_USER_ITEM_CONFIRM_USER_IS_NOT_SUBSCRIBED_TO_GROUPS',
       'Can not transfer because transferee %s is not subscribed to group %s.');
...
define('_MD_XOONIPS_TRANSFER_USER_REQUESTED_ITEM_CONFIRM_LIMIT_CHECK_OUT_OF_BOUNDS',
