...
//  Install script for XooNIps Tool item type module
/**
 * @param $xoopsMod
 * @return bool
 */
function xoops_module_install_xnptool($xoopsMod)
{
    global $xoopsDB;
    ...
    $sql   = "INSERT INTO $table ( name, display_name, mid, viewphp ) VALUES ( 'xnptool', 'Tool', $mid, 'xnptool/include/view.php' )";
    ...
    $mid   = $xoopsMod->getVar('mid');
    $sql   = "INSERT INTO $table ( name, display_name, mid ) VALUES ( 'tool_data', 'Tool Data', $mid )";
    if ($xoopsDB->query($sql) == false) {
        // cannot register itemtype
        return false;
    }
