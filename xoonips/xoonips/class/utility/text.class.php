...
//            '/&amp;([a-zA-Z][0-9a-zA-Z]+);/e',
        ...
        $text = preg_replace($pattern, $replacement, htmlspecialchars($text, ENT_QUOTES));
        ...
        $text3 = preg_replace('/&amp;#([xX][0-9a-fA-F]+|[0-9]+);/', '&#\\1;', $text2);

        //2
        $text4 = preg_replace_callback('/&amp;([a-zA-Z][0-9a-zA-Z]+);/', function ($m) {
