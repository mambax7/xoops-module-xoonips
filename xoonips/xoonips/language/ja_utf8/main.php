...
define('_MD_XOONIPS_MODERATOR_UNCERTIFY_DESC', 'ユーザ登録を拒否します。<br>拒否理由を以下にお書きください。');
...
define('_MD_XOONIPS_ACCOUNT_DIVISION', '部門/研究室');
...
define('_MD_XOONIPS_ACCOUNT_REJECTED', 'アカウントが承認拒否されました。');
...
define('_MD_XOONIPS_ACCOUNT_REJECTED_NOTIFYSBJ', 'アカウントが承認拒否されました');
