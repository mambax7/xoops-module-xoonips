...
<{foreach item=x from=$block.indexes name=xx}>
    tops[ < {$smarty.foreach.xx.iteration
}>
    -1
]
    =
...
<div style="border: 0 solid #b7d0d5; padding: 0; margin: 0; width: 100%;">
<div style="float: none; clear: both; margin: 0 0 3px 0; padding: 0;">
...
<div style="margin: 0; padding: 0;" id="xoonips_tree_tab">
<{foreach item=index from=$block.indexes}>
<{if $block.isKHTML }>
  <table id="xoonipsTab<{$index.item_id}>" cellspacing="0" style="display: inline-table; border-collapse: separate; border-spacing: 0; width: auto; margin: 0 -1px; position: relative; z-index: 0;">
<{else}>
  <table id="xoonipsTab<{$index.item_id}>" cellspacing="0" style="display: inline; border-collapse: separate; border-spacing: 0; width: auto; margin: 0 -1px; position: relative; z-index: 0;">
<{/if}>
   <tr>
