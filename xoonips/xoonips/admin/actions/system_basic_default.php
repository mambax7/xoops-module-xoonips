...
$xmemberHandler = xoops_getHandler('member');
$grouplist = $xmemberHandler->getGroupList(new Criteria('groupid', XOOPS_GROUP_ANONYMOUS, '!='));
$moderator_gid = array();
...
$tmpl->readTemplatesFromFile('system_basic.tmpl.tpl');
