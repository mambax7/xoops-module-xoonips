...
// Templates
$modversion['templates'][1]['file']        = 'xnpsimulator_list_block.tpl';
$modversion['templates'][1]['description'] = 'list block';
$modversion['templates'][2]['file']        = 'xnpsimulator_register_block.tpl';
$modversion['templates'][2]['description'] = 'register block';
$modversion['templates'][3]['file']        = 'xnpsimulator_detail_block.tpl';
$modversion['templates'][3]['description'] = 'detail block';
$modversion['templates'][4]['file']        = 'xnpsimulator_confirm_block.tpl';
$modversion['templates'][4]['description'] = 'confirm block';
$modversion['templates'][5]['file']        = 'xnpsimulator_search_block.tpl';
$modversion['templates'][5]['description'] = 'search block';
$modversion['templates'][6]['file']        = 'xnpsimulator_transfer_item_detail.tpl';
$modversion['templates'][6]['description'] = '';
$modversion['templates'][7]['file']        = 'xnpsimulator_transfer_item_list.tpl';
