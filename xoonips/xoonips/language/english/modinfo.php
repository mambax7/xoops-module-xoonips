...
define('_MI_XOONIPS_USER_ITEM_TRANSFER_NOTIFYDSC',
       'Receive notification when you are requested to inherit items or your request to transfer items is accepted/rejected');
