...
class XooNIpsXmlRpcTransformElement
{
    ...
    {
        if (isset($field) && !empty($field) && isset($child)
            && (is_subclass_of($child, 'XooNIpsXmlRpcTransformElement')
                || get_class($child) === 'XooNIpsXmlRpcTransformElement')
        ) {
...
class XooNIpsXmlRpcTransformCompo extends XooNIpsXmlRpcTransformElement
{
    ...
    public function getObject($in_array)
    {
        ...
        $primary_id = false;
        foreach ($this->iteminfo['io']['xmlrpc']['item'] as $input) {
            if ($input['orm']['field'][0]['orm'] == $this->iteminfo['ormcompo']['primary_orm']
                && $input['orm']['field'][0]['field'] == $this->iteminfo['ormcompo']['primary_key']
            ) {
...
{
    /**
     * XooNIpsXmlRpcTransformFactory constructor.
     */
...
{
    /**
     * XooNIpsXmlRpcTransformCompoFactory constructor.
     */
    public function __construct()
    {
    }
