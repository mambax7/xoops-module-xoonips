...
class XooNIpsViewTransferAdminItemSelect extends XooNIpsViewTransfer
{
    ...
    public function render()
    {
        ...
        $xoopsTpl->assign('transfer_item_options_hidden', array_merge(array_slice($transfer_item_options, 0, ($this->_params['page'] - 1) * 50),
        ...
        $form = $xoopsTpl->fetch('db:xoonips_transfer_admin_item_select.tpl');
