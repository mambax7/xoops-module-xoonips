...
switch ($op) {
    ...
    case 'update':
        ...
        if (!$admin_xgroupHandler->updateGroup($gid, $gname, $gdesc, $gadmin_uids, $gilimit, $gxlimit, $gslimit * 1000 * 1000)) {
    ...
    case 'register':
        ...
        if (!$admin_xgroupHandler->createGroup($gname, $gdesc, $gadmin_uids, $gilimit, $gxlimit, $gslimit * 1000 * 1000)) {
    ...
    case 'delete':
        ...
        if (!$admin_xgroupHandler->deleteGroup($gid)) {
