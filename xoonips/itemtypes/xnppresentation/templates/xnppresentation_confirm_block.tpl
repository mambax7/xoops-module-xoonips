...
<{include file='db:xoonips_confirm_multiple_field.tpl' vars=$xnppresentation_creator}>
    </td>
  </tr>
...
<input type="hidden" name="creator" value="<{$detail.creator.html_string}>"/>
