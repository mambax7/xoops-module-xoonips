...
$reg_form->addElement(new XoopsFormText(_US_NICKNAME . _MD_XOONIPS_ACCOUNT_REQUIRED_MARK, 'uname', $uname_size, $uname_size,
                                        $textutil->html_special_chars($uname)), true);
$reg_form->addElement(new XoopsFormText(_US_REALNAME . $required['realname']['mark'], 'realname', 30, 60, $textutil->html_special_chars($realname)),
                      $required['realname']['flag']);
...
$reg_form->addElement(new XoopsFormPassword(_US_PASSWORD . _MD_XOONIPS_ACCOUNT_REQUIRED_MARK, 'pass', 10, 32, $textutil->html_special_chars($pass)),
                      true);
$reg_form->addElement(new XoopsFormPassword(_US_VERIFYPASS . _MD_XOONIPS_ACCOUNT_REQUIRED_MARK, 'vpass', 10, 32,
                                            $textutil->html_special_chars($vpass)), true);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_COMPANY_NAME . $required['company_name']['mark'], 'company_name', 60, 255,
                                        $textutil->html_special_chars($company_name)), $required['company_name']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_DIVISION . $required['division']['mark'], 'division', 60, 255,
                                        $textutil->html_special_chars($division)), $required['division']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_TEL . $required['tel']['mark'], 'tel', 25, 32, $textutil->html_special_chars($tel)),
                      $required['tel']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_FAX . $required['fax']['mark'], 'fax', 25, 32, $textutil->html_special_chars($fax)),
                      $required['fax']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_ADDRESS . $required['address']['mark'], 'address', 60, 255,
                                        $textutil->html_special_chars($address)), $required['address']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_COUNTRY . $required['country']['mark'], 'country', 25, 255,
                                        $textutil->html_special_chars($country)), $required['country']['flag']);
$reg_form->addElement(new XoopsFormText(_MD_XOONIPS_ACCOUNT_ZIPCODE . $required['zipcode']['mark'], 'zipcode', 20, 32,
                                        $textutil->html_special_chars($zipcode)), $required['zipcode']['flag']);
