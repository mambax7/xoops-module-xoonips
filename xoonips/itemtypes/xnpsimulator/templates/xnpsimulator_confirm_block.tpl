...
<{/if}>
  ...
  <tr>
    ...
    <td class="<{cycle name="oddeven"}>"><{$detail.simulator_type.display_value}></td>
  </tr>
  <tr>
    <td class="head"><{$smarty.const._MD_XNPSIMULATOR_DEVELOPER_LABEL}></td>
    <td class="<{cycle name="oddeven"}>">
<{include file='db:xoonips_confirm_multiple_field.tpl' vars=$xnpsimulator_developer}>
    </td>
  </tr>
  <tr>
...
<input type="hidden" name="simulator_type" value="<{$detail.simulator_type.tpl_string}>"/>
