...
function xnpstimulusGetListBlock($item_basic)
{
    ...
    $tpl->assign('xoonips_item', $xnpstimulusHandler->getTemplateVar(XOONIPS_TEMPLATE_TYPE_ITEM_LIST, $item_basic['item_id'], $myuid));

    // return as HTML
    return $tpl->fetch('db:xnpstimulus_list_block.tpl');
}
...
function xnpstimulusGetDetailBlock($item_id)
{
    ...
    $xnpstimulusHandler = xoonips_getOrmCompoHandler('xnpstimulus', 'item');
    $tpl->assign('xoonips_item', $xnpstimulusHandler->getTemplateVar(XOONIPS_TEMPLATE_TYPE_ITEM_DETAIL, $item_id, $myuid));

    // return as HTML
    return $tpl->fetch('db:xnpstimulus_detail_block.tpl');
}
...
function xnpstimulusGetRegisterBlock()
{
    ...
    $tpl->assign('xnpstimulus_developer',
                 xoonips_get_multiple_field_template_vars(xoonips_get_orm_from_post('xnpstimulus', 'developer'), 'xnpstimulus', 'developer'));
    // return HTML content
    return $tpl->fetch('db:xnpstimulus_register_block.tpl');
}
...
function xnpstimulusGetEditBlock($item_id)
{
    ...
    $tpl->assign('attachment_dl_limit',
                 xnpGetDownloadLimitationOptionEditBlock('xnpstimulus', xnpstimulusGetAttachmentDownloadLimitOption($item_id)));
    $tpl->assign('attachment_dl_notify',
                 xnpGetDownloadNotificationOptionEditBlock('xnpstimulus', xnpstimulusGetAttachmentDownloadNotifyOption($item_id)));
    $tpl->assign('detail', $detail);
    $tpl->assign('readme', $readme);
    $tpl->assign('rights', $rights);
...
function xnpstimulusGetConfirmBlock($item_id)
{
    ...
    // return HTML content
    return $tpl->fetch('db:xnpstimulus_confirm_block.tpl');
}
...
function xnpstimulusGetAdvancedSearchBlock($search_var)
{
    ...
    // return HTML content
    return $tpl->fetch('db:xnpstimulus_search_block.tpl');
}
 ...
 * @internal param 添付ファイル $attachment ・画像ファイルをExportするときtrue．未指定時false．
 */
...
{
    return xnpGetTopBlock($itemtype['name'], $itemtype['display_name'], 'images/icon_stimulus.gif', _MD_XNPSTIMULUS_EXPLANATION,
                          'xnpstimulus_stimulus_type', xnpstimulus_get_type_array());
}
