        ...
        <table id="export_config_table" class="outer">
         <tr>
          <th style="text-align:left;" colspan="2">
           <input type="$export_type_item_type" name="export_type" value="item" checked />$export_type_item
          </th>
         </tr>
EOT;
    if ($index_id != '') {
        echo <<<EOT
         <tr class="odd">
          ...
          <td>
           <input type="radio" name="recursive_item" value="1" checked />$yes
...
EOT;
    ...
    if ($value === 'on') {
        ...
        <tr class="even">
         ...
         <td>
          <input type="radio" name="attachment" value="1" checked />$yes
    ...
    if ($index_id != '') {
        ...
        <tr>
         ...
         <tr class="odd">
          ...
          <td>
           <input type="radio" name="recursive_index" value="1" checked />$yes
 ...
 * @internal param output $outfile file path(UTF-8)
 */
