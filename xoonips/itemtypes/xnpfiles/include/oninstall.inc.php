...
//  Install script for XooNIps File item type module
/**
 * @param $xoopsMod
 * @return bool
 */
function xoops_module_install_xnpfiles($xoopsMod)
{
    global $xoopsDB;
    ...
    $sql   = "INSERT INTO $table ( name, display_name, mid, viewphp ) VALUES ( 'xnpfiles', 'File', $mid, 'xnpfiles/include/view.php' )";
    ...
    $mid   = $xoopsMod->getVar('mid');
    $sql   = "INSERT INTO $table ( name, display_name, mid ) VALUES ( 'files_file', 'Data file of Files', $mid )";
    if ($xoopsDB->query($sql) == false) {
        // cannot register itemtype
        return false;
    }
