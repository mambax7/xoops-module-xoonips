...
$iteminfo['orm'][] = array(
    ...
    'name'        => 'item_detail',
    'field'       => 'detail',
    'foreign_key' => 'binder_id',
    'multiple'    => false,
    'required'    => true
);
$iteminfo['orm'][] = array(
    'module'      => 'xnpbinder',
    'name'        => 'binder_item_link',
    'field'       => 'binder_item_links',
    'foreign_key' => 'binder_id',
    'multiple'    => true
);
...
$iteminfo['ormfield']['binder_item_links'] = array(
    array(
        'name'     => 'binder_item_link_id',
        'type'     => 'int',
        'required' => true
    ),
    array(
