...
{
    /**
     * XooNIpsOrmItemBasic constructor.
     */
...
class XooNIpsOrmItemBasicHandler extends XooNIpsTableObjectHandler
{
    ...
    {
        $item_lockHandler = xoonips_getOrmHandler('xoonips', 'item_lock');
        $item_lockHandler->lock($item_id);
        $item_lockHandler->lockIndexes($index_id);
    }
    ...
    {
        $item_lockHandler = xoonips_getOrmHandler('xoonips', 'item_lock');
        $item_lockHandler->unlock($item_id);
        $item_lockHandler->unlockIndexes($index_id);
    }
}
