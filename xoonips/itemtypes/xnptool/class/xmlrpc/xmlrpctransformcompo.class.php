...
/**
 *
 * XmlRpcTransform composer class for Tool type
 *
 *
 */
class XNPToolXmlRpcTransformCompo extends XooNIpsXmlRpcTransformCompo
{
    /**
     * XNPToolXmlRpcTransformCompo constructor.
     */
