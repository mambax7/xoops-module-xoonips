...
{
    /**
     * XooNIpsActionTransfer constructor.
     */
    ...
    {
        return xoonips_transfer_is_private_item_number_exceeds_if_transfer($to_uid, $transfer_item_ids)
               || xoonips_transfer_is_private_item_storage_exceeds_if_transfer($to_uid, $transfer_item_ids);
    }
    ...
    public function is_readable_all_items($item_ids, $uid)
    {
        ...
        foreach ($item_ids as $id) {
            if (!$itemHandler->getPerm($id, $uid, 'read')) {
                return false;
            }
        }
